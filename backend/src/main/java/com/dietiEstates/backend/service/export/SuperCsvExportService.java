...
@Service
@Slf4j
public class SuperCsvExportService extends ExportServiceTemplate implements CsvExportService
{
    public SuperCsvExportService(AgentRepository agentRepository, AgentService agentService, RealEstateRepository realEstateRepository) 
    {
