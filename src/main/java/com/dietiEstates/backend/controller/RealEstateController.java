...
public class RealEstateController 
{
    ...
    public ResponseEntity<List<RealEstatePreviewDTO>> aaa(@RequestParam("page") Integer page, @RequestParam("limit") Integer limit, @RequestParam Map<String,String> filters) 
    {
