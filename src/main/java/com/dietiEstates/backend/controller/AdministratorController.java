...
public class AdministratorController
{
    ...
    public ResponseEntity<?> createCollaborator(@PathVariable String username, @RequestBody UserDTO collaboratorDTO) 
    {
        try 
        {
            administratorService.createCollaborator(username, collaboratorDTO);
            return ResponseEntity.status(HttpStatus.CREATED).build();
        } 
